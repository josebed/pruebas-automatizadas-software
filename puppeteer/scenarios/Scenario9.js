...
const SCENARIO = "./artifacts/scenario9";
...
module.exports = async () => {
  ...
  await PageObjects.CreateTag(page, SCENARIO, Properties.TagTitle4);
  ...
  await PageObjects.DeleteTag(page, SCENARIO, Properties.TagTitle4);
