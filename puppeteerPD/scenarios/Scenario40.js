...
const SCENARIO = "./artifacts/scenario40";
...
module.exports = async () => {
  ...
  const result =  await PageObjects.AddMember(page, SCENARIO, dataPoolApriori.emptyText, faker.fake(`${faker.lorem.word(191)}@${faker.internet.domainName}`));
