...
const SCENARIO = "./artifacts/scenario15";
...
module.exports = async () => {
  ...
  // When I Log In and revoke invited
  await PageObjects.LogIn(page, SCENARIO);
  await PageObjects.RevokeInviteStaff(page, SCENARIO);
  
  // Then I shouldn't see it in the list of invited users.
