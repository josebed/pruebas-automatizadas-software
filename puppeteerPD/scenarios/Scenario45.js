...
const SCENARIO = "./artifacts/scenario45";
...
module.exports = async () => {
  ...
  const result =  await PageObjects.AddMember(page, SCENARIO,  dataPool.member.name, faker.internet.email(), faker.lorem.word(501));
