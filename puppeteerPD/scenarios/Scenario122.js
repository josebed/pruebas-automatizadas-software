...
const SCENARIO = "./artifacts/scenario122";
...
module.exports = async () => {
  ...
  // When I Log In and change the facebook description...
  ...
  const fieldID = 'ogDescription'
  await PageObjects.ClearInputByID(page, fieldID);

  //...to something longuer...
  const fields = {
    [`#${fieldID}`]: faker.random.alpha(301),
  };
